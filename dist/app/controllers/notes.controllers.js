...
exports.notesRoutes.get("/", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const note = yield notes_models_1.Note.find();
    res.status(201).json({
        success: true,
...
exports.notesRoutes.get("/:noteId", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const note = yield notes_models_1.Note.findById(noteId);
    res.status(201).json({
        success: true,
        message: "Notes read successfully",
        note,
...
exports.notesRoutes.patch("/:noteId", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const note = yield notes_models_1.Note.findByIdAndUpdate(noteId, updatedBody);
    res.status(201).json({
        success: true,
